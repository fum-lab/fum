...
Источник: <https://www.swift.org/sswg/incubation-process.html>

## Содержимое

SSWG Incubation Process | Swift.org
Docs
Community
Packages
Blog
...
The SSWG steering group has a similar role to the Swift Core Team and will make the final decision on moving pitches/proposals through the incubation process based on the feedback of the community.
...
Publish a forum post in the server proposals area soliciting feedback from the community.
...
Process Diagram
Ecosystem Index
All projects and their respective levels will be listed on the Swift Server Ecosystem Index .
...
Blocking code should be wrapped in NIOThreadPool (like Vapor’s SQLite package)
...
<!-- content-sha256: sha256:b29ef68351267342727bbfafd085f7bb9af75e42cd39af3b47419bf26e50eb75 -->
<!-- FUM-MD-RECENCY:END -->
