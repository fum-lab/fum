...
def создать(основание):
    ...
    return {'схема':'fum.привязки-переноса.1','владелец':ВЛАДЕЛЕЦ,'источник':str(исходный),'назначение':str(основание/'новый-родитель/назначение'),'общий':str(основание/'главный/.git'),'состояние':str(состояние)}
