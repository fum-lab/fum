...
def проверить(каталог, хэш, адрес=True):
    ...
    требовать(манифест["схема"] == "fum.комплект-Stop.2", "схема")
...
def подготовить(аргументы):
    ...
    манифест = {"схема": "fum.комплект-Stop.2", "commit": аргументы.commit, "tree": дерево,
    ...
    return {"схема": "fum.кандидат-комплекта-Stop.2", "каталог": str(цель), "sha256": хэш,
