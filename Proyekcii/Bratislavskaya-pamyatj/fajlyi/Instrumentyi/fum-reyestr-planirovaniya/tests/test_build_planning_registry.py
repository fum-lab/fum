...
class BuildPlanningRegistryTests(unittest.TestCase):
    ...
    def write_fixture(self, root: Path) -> Path:
        ...
        (root / "Планирование" / "дорожная-карта.md").write_text(
            ...
            "## Горизонт 2. Второй тестовый горизонт\n\n"
            "Тестовый горизонт без назначенного шага.\n\n"
            "## Горизонт 3. Третий тестовый горизонт\n\n"
            "Тестовый горизонт без назначенного шага.\n\n"
            "## Горизонт 4. Четвёртый тестовый горизонт\n\n"
            "Тестовый горизонт без назначенного шага.\n\n"
            "## Горизонт 5. Пятый тестовый горизонт\n\n"
            "Тестовый горизонт без назначенного шага.\n\n"
            "## Горизонт 6. Шестой тестовый горизонт\n\n"
            "Тестовый горизонт без назначенного шага.\n\n"
            "## Горизонт 7. Седьмой тестовый горизонт\n\n"
            "Тестовый горизонт без назначенного шага.\n\n"
            "## Горизонт 8. Восьмой тестовый горизонт\n\n"
            "Тестовый горизонт без назначенного шага.\n\n"
            ...
            "| [Горизонт 2](#горизонт-2-второй-тестовый-горизонт) | Нет назначенного шага |\n"
            "| [Горизонт 3](#горизонт-3-третий-тестовый-горизонт) | Нет назначенного шага |\n"
            "| [Горизонт 4](#горизонт-4-четвёртый-тестовый-горизонт) | Нет назначенного шага |\n"
            "| [Горизонт 5](#горизонт-5-пятый-тестовый-горизонт) | Нет назначенного шага |\n"
            "| [Горизонт 6](#горизонт-6-шестой-тестовый-горизонт) | Нет назначенного шага |\n"
            "| [Горизонт 7](#горизонт-7-седьмой-тестовый-горизонт) | Нет назначенного шага |\n"
            "| [Горизонт 8](#горизонт-8-восьмой-тестовый-горизонт) | Нет назначенного шага |\n",
            encoding="utf-8",
        )
    ...
    def test_build_registry_uses_requirement_cards_as_canonical_requirements(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                ...
                {
                    "вид": "горизонт",
                    "идентификатор": "horizon-8",
                    "название": "Восьмой тестовый горизонт",
                    "файл": "Планирование/дорожная-карта.md#горизонт-8-восьмой-тестовый-горизонт",
                    "карточки": [],
                },
            )
    ...
    def test_дорожная_карта_требует_точные_горизонты_от_нуля_до_восьми(сам):
        with tempfile.TemporaryDirectory() as временный_каталог:
            корень = Path(временный_каталог)
            сам.write_fixture(корень)
            карта = корень / "Планирование" / "дорожная-карта.md"
            ...
            текст = "\n".join(
                строка
                for строка in текст.splitlines()
                if not строка.startswith("## Горизонт 8.")
                and not строка.startswith("| [Горизонт 8]")
            ) + "\n"
            карта.write_text(текст, encoding="utf-8")

            with сам.assertRaisesRegex(
                ValueError,
                "roadmap horizon ids must exactly cover horizon-0..horizon-8.*horizon-8",
            ):
                build_planning_registry.build_registry(корень)
