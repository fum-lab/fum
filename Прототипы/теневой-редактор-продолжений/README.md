...
Общий [smoke-check репозитория](../../Инструменты/fum-kompleksnaya-proverka-repozitoriya/SKILL.md) автоматически находит пакет, сверяет оба исполняемых продукта с проверяемым инвентарём, запускает 30 автономных тестов, отдельно собирает оба продукта и применяет строгий `swift format lint` к манифесту и всем Swift-файлам целей. Историческое хэш-привязанное исключение удалено после отдельной механической нормализации всего пакета; текущая [политика SwiftPM-пакетов](../../Инструменты/fum-kompleksnaya-proverka-repozitoriya/swift-package-policy.json) не ослабляет lint для теневого редактора.
...
<!-- content-sha256: sha256:8db35130fbfe8227b0c66d368cb0e772e0116fc8b118d2bce443f78beffdd797 -->
<!-- FUM-MD-RECENCY:END -->
