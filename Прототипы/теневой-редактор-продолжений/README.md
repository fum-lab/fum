...
Общий [smoke-check репозитория](../../Инструменты/fum-kompleksnaya-proverka-repozitoriya/SKILL.md) автоматически находит пакет, сверяет оба исполняемых продукта с проверяемым инвентарём, запускает 30 автономных тестов и отдельно собирает оба продукта. Строгий `swift format lint` для исторического снимка пакета временно заменён видимым хэш-привязанным исключением в [политике SwiftPM-пакетов](../../Инструменты/fum-kompleksnaya-proverka-repozitoriya/swift-package-policy.json): любое изменение Swift-исходников, манифеста или центральной конфигурации форматтера делает исключение устаревшим. Критерий снятия — отдельная механическая нормализация всего пакета, после которой строгий lint, тесты и обе сборки остаются зелёными.
...
<!-- content-sha256: sha256:af306984c04b731c0acf133ef7da84982a48516e54b0eb070136061aa9d639b0 -->
<!-- FUM-MD-RECENCY:END -->
