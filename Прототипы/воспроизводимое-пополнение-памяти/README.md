...
Прототип доказывает самодостаточное переисполнение сохранённых принятых событий, межпроцессный CAS файлового указателя для сотрудничающих писателей и process-crash consistency на восьми контрольных точках текущего локального macOS-стенда. За границей остаются журнал отклонённых кандидатов, power-loss durability, языконейтральность канонических байтов, чтение или миграция схемы поколения `1`, сборка мусора, сетевые файловые системы, внутрипроцессная многопоточность, масштабирование, разграничение доступа, качество автоматически найденных структурирующих операторов, агентский цикл и способность FUM самостоятельно синтезировать следующий исполняемый пакет. Фикстура является версионированным инженерным сценарием, а не записью живой модели.

Статус: действующий безоконный Swift-прототип с поколениями схемы `2`, полным каноническим журналом принятых событий, самодостаточным replay снимка, трассы, происхождения и инертной декларативной модели представления, межпроцессным CAS `CURRENT` и проверенной согласованностью после аварии процесса. Журнал отклонённых кандидатов, power-loss durability, языконейтральный байтовый профиль, GUI и renderer отсутствуют.
...
<!-- content-sha256: sha256:456682132cfcd83576c6440d7f0f344119d52b023310dce41cbd53f91ca11b20 -->
<!-- FUM-MD-RECENCY:END -->
