...
[Воспроизводимый стенд UTF-8](сравнение-декодирования.md) сравнивает текущий интерпретатор со строгим стандартным Swift на одинаковых скалярах и UTF-32LE. Руководство содержит команды, открытый корпус, измерения Release и ограничения сравнения полного API.
...
<!-- content-sha256: sha256:e984391ae438c3eb77f1bdca6a717e428502302ddc563ca21e8873ae2f385987 -->
<!-- FUM-MD-RECENCY:END -->
