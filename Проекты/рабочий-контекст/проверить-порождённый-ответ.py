...
class ПроверкаПорождённогоОтвета(unittest.TestCase):
    ...
    def test_пустота_и_обязательное_присутствие_полей(проверка):
    ...
    def test_границы_целых64_и_лексические_отказы(проверка):
    ...
    def test_точный_хэш_бюджет_и_доступность_оригинала(проверка):
        import tempfile
        данные = вход()
        хэш = hashlib.sha256(данные).hexdigest()
