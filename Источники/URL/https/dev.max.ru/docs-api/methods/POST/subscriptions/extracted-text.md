...
После вызова метода POST /subscriptions события отправляются на указанный Webhook-endpoint в виде HTTPS POST-запросов с объектом Update
...
Список типов событий, которые хочет получать ваш бот. Полный список смотрите в описании объекта Update
secret
string optional
^[a-zA-Z0-9_-]{5,256}$
...
<!-- content-sha256: sha256:cc42f04115dd1f7b4620d10f9a794852a1c8ea9f9c971fc6bcfd63d7ce109bb5 -->
<!-- FUM-MD-RECENCY:END -->
