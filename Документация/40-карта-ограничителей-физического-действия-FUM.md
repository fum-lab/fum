...
## Сон не вооружает исполнительный контур

[Механизм сна FUM](../Глоссарий/механизм-сна-FUM.md) остаётся модельным режимом R0 независимо от ширины ветвления, необычности гипотезы или успешности внутренней проверки. Повышенная изменчивость применяется только к кандидатным преобразованиям и не может подключить привод, сырой носитель, внешнюю систему, публикацию, сообщение или платёж, повысить уровень доступа либо создать подтверждение и авторизацию.

Физическая карта не называет вычисление отсутствием реального эффекта: локальная работа, энергия и хранение трассы существуют в материальном мире. Для сна действует более узкий положительный конверт заранее разрешённых вычисления, журнала, кандидата и контрольной точки. Результат пробуждения возвращается в модельный разбор; переход к физическому действию начинается заново с точной версии кандидата и проходит все барьеры этой карты без наследования допуска по сходству.
...
- [исходный запрос текущей рабочей сессии](../Журнал/2026-07-23_17-37-10_MSK_описать-карту-ограничителей-физического-действия-FUM/запрос.md)
...
<!-- content-sha256: sha256:cc22e9c4b5a6ede760f88615b6d9c972674fbb7e7cdb554e14e56d545e979de2 -->
<!-- FUM-MD-RECENCY:END -->
