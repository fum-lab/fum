...
Для практической работы начните с документа [«Как сейчас работать с FUM»](52-текущий-порядок-работы.md). Для знакомства с замыслом проекта достаточно прочитать [обзор проекта](00-обзор-проекта.md), [архитектуру FUM](22-архитектура-FUM.md), [основную пользовательскую историю связной памяти](31-пользовательские-истории-FUM/вести-связную-память-FUM.md) и [паспорт текущего документационного прототипа](36-паспорт-документационного-прототипа-и-первого-коробочного-среза.md). Термины раскрывает [глоссарий проекта](../Глоссарий/глоссарий-проекта.md), а практические продолжения собраны в [карточках шагов](../Планирование/карточки-шагов/README.md).
...
- [Наблюдения macOS и интерпретатор операторов](наблюдения-macOS-и-интерпретатор.md) — принятый контракт слоя Swift и долговечной памяти обращений.
- [Архивный снимок одной задачи FUMA](архивный-снимок-задачи-FUMA.md)
...
- [52 — Как сейчас работать с FUM](52-текущий-порядок-работы.md)
- [53 — Вселенная FUM: аналитическая основа и художественные произведения](53-вселенная-FUM/README.md)
...
- [Повторное применение операторов FUMA](повторное-применение-операторов-FUMA.md) — определения, экземпляры, совместимость и граница динамической сборки.
...
- [52 — Модель бетонных глубинных сооружений и подводных грузовых систем](52-модель-бетонных-глубинных-систем.md)
...
<!-- content-sha256: sha256:9fc2e95d438f509c6ccca31bf817a59d164e1814e8bc44a75f58a7fd9fcab88f -->
<!-- FUM-MD-RECENCY:END -->
