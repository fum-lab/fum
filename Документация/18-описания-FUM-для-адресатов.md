...
`fum-pisatelj` является технической идентичностью [дочернего fork-агента FUM](../Глоссарий/дочерний-fork-агент-FUM.md), которому преимущественно назначается [контекстная роль](../Глоссарий/контекстная-роль-FUM-агента.md) писателя. Он создаёт [техническое самоописание FUM](../Глоссарий/техническое-самоописание-FUM.md): описывает устройство, состояние, ограничения и способы работы FUM, включая наблюдаемые особенности собственной конфигурации, но остаётся производителем текста, а не новым источником истины.

Писатель получает точный срез документации, глоссария, вопросов, паспортов и проверяемых свидетельств. Каждому утверждению о собственном runtime или устройстве назначается один статус: наблюдение, вывод, гипотеза или неизвестное. Самоописание модели не считается прямой интроспекцией её весов или скрытых состояний, а совпадение с внутренним ощущением сессии не заменяет внешне проверяемого источника.

Назначение писателя явно выбирает форму результата. Интеграция уже зафиксированных требований и архитектуры проходит как обычная производная документация; адаптация для конкретного читателя или жанра — как описание FUM для адресата с паспортом аудитории. Если в ходе письма появляется новая проектная мысль, она сначала проходит обычную фиксацию в канонической памяти. Только после этого последующая пересборка может включить её в каноническую документацию либо адресное описание выбранного жанра. Так роль писателя не образует параллельный слой требований.
...
<!-- content-sha256: sha256:00749196a0c32c3a3d0b02d1cc3d62a8237818603ab64af68eca2b217cb2c6fd -->
<!-- FUM-MD-RECENCY:END -->
