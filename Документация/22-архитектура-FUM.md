...
- [агентский цикл](../Глоссарий/агентский-цикл.md) превращает память и задачу в действие, проверку и обновление состояния, а в целевом виде служит исполняемым участком [обобщенного дарвиновского алгоритма](../Глоссарий/обобщенный-дарвиновский-алгоритм.md);
...
| [Общие схемы FUM](../Глоссарий/общая-схема-FUM.md) | Поднимают несколько примеров или реализаций до переносимого описания инвариантов, вариаций и границ применимости. | [Обобщенный поиск повторяющихся последовательностей](08-обобщенный-поиск-повторяющихся-последовательностей.md), [Воспроизводимые автоматизации FUM](17-воспроизводимые-автоматизации.md) |
