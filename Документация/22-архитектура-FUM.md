...
| [Интерфейс FUM-узла](../Глоссарий/интерфейс-FUM-узла.md) | Задаёт внутреннюю и внешнюю границу узла: наблюдаемые состояния, доступные операции, входные сигналы, выходные результаты, права, подтверждения и трассы. | [Интерфейс FUM-узла](25-интерфейс-FUM-узла.md), [Доступ к внутренним состояниям](07-доступ-к-внутренним-состояниям.md), [FUM как единая точка взаимодействия с компьютером](19-единая-точка-взаимодействия-с-компьютером.md) |
