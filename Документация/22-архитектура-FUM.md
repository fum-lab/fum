...
- Каждый значимый сетевой акт должен отделять языковую роль от технической идентичности: `я`, `ты`, `мы`, `вы`, `они` задают относительную семантику участников, но не заменяют идентификаторы узлов, состав групп, происхождение, полномочия, [уровни доступа](../Глоссарий/уровень-доступа.md) и протокол доставки.
...
<!-- content-sha256: sha256:9723a404994ea984c651009b8ca265fcdef70e57d7832654239be51b953de464 -->
<!-- FUM-MD-RECENCY:END -->
