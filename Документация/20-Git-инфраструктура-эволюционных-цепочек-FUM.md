...
Начальный локальный профиль параллельного исполнения использует конечный пул переиспользуемых linked worktree `Подузлы/слот-*` одного репозитория. До резервирования обычная новая сессия в основном checkout, чистом вне точного корневого `.obsidian/`, строит exact committed routing snapshot: точный OID целевой вершины, OID обязательных плановых источников, объект и ревизию протокола пула, все активные назначения и линии с их полными refs, worktree и состоянием branch-scoped FIFO, а также свободные слоты. Маршрутизация сохраняет байты исключённой области, но отклоняет грязь в любом другом пути. Канонический хэш связывает решение с этим состоянием; изменившийся источник, ref, владелец или ожидающий билет требует нового снимка и нового выбора.
...
<!-- content-sha256: sha256:277a1a08c0c094a1ef8f36792b657b631af0dad7cbad1f08efbe3e9262c639fc -->
<!-- FUM-MD-RECENCY:END -->
