...
- [Фрактальность](../Глоссарий/фрактальный-узел-мышления.md) [FUM](../Глоссарий/FUM.md) должна выражаться не только в образе проекта, но и в архитектуре: узел может быть простой функцией, агентом, workflow или вложенной сетью, а сеть может становиться узлом следующего уровня.
