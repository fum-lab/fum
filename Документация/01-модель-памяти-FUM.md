...
Структурирующие операторы в памяти должны образовывать иерархию, а не один общий слой правил. Низкие операторы могут быть привязаны к конкретному языку, письменности или формату: например, к русскому окончанию, суффиксу, варианту транслитерации или связи кириллической и латинской записи. Более высокие операторы должны связывать уже семантические структуры: они могут соединять русские и английские конструкции, если сохраняют общий смысл, роль в высказывании или переводимый шаблон и явно указывают, какие поверхностные детали теряются.
...
<!-- content-sha256: sha256:9e64c931358c5f319b9486b8edbbbe2b35f47b61f2e46fd0c13edb0a0560724f -->
<!-- FUM-MD-RECENCY:END -->
