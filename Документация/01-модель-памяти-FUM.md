...
Это приближение не сводит всю память к тексту. Код, структурированные данные, ссылки, метаданные, тесты, импортированные источники, вложения и Git-история тоже входят в [память FUM](../Глоссарий/память-FUM.md). Двухслойная текстовая формула описывает доминирующий семантический носитель нынешней стадии и её происхождение, но не целевую онтологию FUM. Внешняя сессия Codex пока не является собственным [агентским циклом](../Глоссарий/агентский-цикл.md) FUM и доказывает лишь внешне организованный контур памяти и отбора.
...
<!-- content-sha256: sha256:fff05c53e5f7840b8c41e29738b83302935b0e289c7b944caa98e391073cfbbf -->
<!-- FUM-MD-RECENCY:END -->
