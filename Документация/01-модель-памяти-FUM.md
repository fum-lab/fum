...
Внешняя сессия Codex не является собственным исполняемым [агентским циклом](../Глоссарий/агентский-цикл.md) FUM: модель, создание задач и оркестрация остаются во внешней среде. Однако Git-память, заранее создаваемое [обязательное продолжение ветки](../Глоссарий/обязательное-продолжение-ветки.md), FIFO-очередь, повторный выбор следующего шага и атомарная передача уже образуют поведенческий прототип непрерывно возобновляемого контура на масштабе дискретных задач. Память здесь служит носителем причинной непрерывности: результат одного поколения меняет доступный контекст и продолжение следующего.
...
Канонический кириллический слой получает хранимую [братиславскую проекцию](50-братиславская-версия-памяти-FUM.md) на русском языке латиницей. Проекция односторонне выводится из точного снимка, покомпонентно преобразует полный путь, сохраняет связь происхождения и никогда не участвует во входном инвентаре как самостоятельная память.
...
<!-- content-sha256: sha256:705288dbe1d5268d2623a34e3b316823472cf2cdb7631d7ca4686a8302a88a33 -->
<!-- FUM-MD-RECENCY:END -->
