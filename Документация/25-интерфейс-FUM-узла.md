...
Первый паспорт может быть не универсальным, а локальным: например, для узла рабочей сессии в этом репозитории. Он должен показать, какие данные агент видит внутри, какие команды доступны снаружи, какие действия требуют подтверждения и как итог сохраняется в [памяти FUM](../Глоссарий/память-FUM.md).
