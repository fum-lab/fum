...
Описанный ниже FIFO/pool-конвейер сохранён как исторически реализованная и отложенная архитектура. Он не является действующим маршрутом репозитория после перехода на ручную последовательную схему: каждую пишущую сессию запускает пользователь, она создаёт не более одного локального коммита на `refs/heads/master` и завершается без continuation, selector, worktree-пула или автоматической публикации. Возврат этого контура потребует отдельного пользовательского запроса и нового проверенного перехода правил.
...
<!-- content-sha256: sha256:19f885c8170c2df2940c2c045a064dfd2b886ee6b3cd4b6833e3b0616506fe17 -->
<!-- FUM-MD-RECENCY:END -->
