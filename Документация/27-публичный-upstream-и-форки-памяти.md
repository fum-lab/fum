...
[Обязательное продолжение ветки](../Глоссарий/обязательное-продолжение-ветки.md) связано с точным полным ref и физическим checkout. Каждый живой пишущий checkout точного рабочего ref хранит собственную FIFO и собственную цепочку продолжений; состояние одного checkout не доказывает состояние другого. Параллельный пишущий контур использует отдельный клон и уникальную ветку шага для каждой попытки, а принятие в один целевой ref сериализует отдельный репозиторный интегратор.
...
<!-- content-sha256: sha256:9986f260624ff985db0c346c68767984659e9e6ec9e77964aff70e979a0b82c9 -->
<!-- FUM-MD-RECENCY:END -->
