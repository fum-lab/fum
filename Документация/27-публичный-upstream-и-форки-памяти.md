...
[Обязательное продолжение ветки](../Глоссарий/обязательное-продолжение-ветки.md) связано с точным полным ref и физическим checkout. Каждый fork или отдельный клон хранит собственную FIFO и собственную цепочку продолжений; состояние одного checkout не доказывает состояние другого. Параллельный пишущий контур использует отдельный клон и уникальную step-ветку для каждой попытки, а принятие в один целевой ref сериализует отдельный репозиторный интегратор.
...
<!-- content-sha256: sha256:7aa79b6a536bfc7fb662e0d3e3aff8457bb250b9015e2d1aeac564ea554d223b -->
<!-- FUM-MD-RECENCY:END -->
