...
Каждая обычная рабочая сессия `master` с осмысленным diff заканчивается локальными проверками и не более чем одним обычным локальным коммитом. Затем задача завершается без continuation; следующую пишущую сессию запускает пользователь. Коммит сам по себе не разрешает `push` или `publish`.
...
<!-- content-sha256: sha256:44e387d047725f9614337945933c99e3632dbd6b1ba8698bbd2be5a9f5683f88 -->
<!-- FUM-MD-RECENCY:END -->
