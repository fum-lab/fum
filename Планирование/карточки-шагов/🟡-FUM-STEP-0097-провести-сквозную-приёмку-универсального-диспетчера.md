...
- Созданные исполнители проходят FIFO и повторную fenced-проверку; плановый тик не меняет checkout, индекс, рабочую ветку, её историю или внешнее состояние, а разрешённые служебные Git-ссылки продвигает только именованными fenced-операциями.
...
- [FUM-СБОЙ-0013/ПРОЯВЛЕНИЕ-0001 — Потеря живости автозапуска после перезаписи завершения](../../Сбои/FUM-СБОЙ-0013-потеря-живости-автозапуска-после-перезаписи-завершения.md#проявления)
...
<!-- content-sha256: sha256:f9922cc33fad9e927053282a26b2ef1d44ca246dc3464953ee8ab20fcaad1c1d -->
<!-- FUM-MD-RECENCY:END -->
