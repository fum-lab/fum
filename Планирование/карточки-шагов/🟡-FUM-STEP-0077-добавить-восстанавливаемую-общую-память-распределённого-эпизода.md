...
Паспорт FUM-STEP-0076 задаёт ссылки между частями эпизода, но без общей восстанавливаемой памяти несколько сессий всё ещё остаются разрозненными чатами. Переносить текущий носитель напрямую нельзя: сначала FUM-STEP-0098–FUM-STEP-0103 должны доказать самодостаточное воспроизведение, CAS, аварийную согласованность, языконейтральные байты и один полный одноагентный эпизод. Эта карточка затем расширяет проверенное ядро на различимые вклады, а не дублирует его дефекты.
...
<!-- content-sha256: sha256:4d14aeba29aebfa37a42b2024a9035e249f1b7d4271fbb6ee183d95ab8f20555 -->
<!-- FUM-MD-RECENCY:END -->
