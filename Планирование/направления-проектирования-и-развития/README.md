...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [01. Память и происхождение](01-память-и-происхождение.md)                           | Сохранять входы, источники, решения, проверки, инструменты, журнал и связи требований как проверяемую [память FUM](../../Глоссарий/память-FUM.md).           | Полная пересборка входного описания для разработчиков из явного набора текущих источников после принятого первого релиза архиватора.                                            | Источники и статусы прослеживаются, ссылки проходят локальную проверку, а корневой индекс и описание не завышают готовность проекта. |
...
<!-- content-sha256: sha256:774dc03b88722b74e220c8a8eac0f53bd5368f27b71f4f8f08fa8dd151fdcf63 -->
<!-- FUM-MD-RECENCY:END -->
