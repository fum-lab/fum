...
| [09. Математика](09-математика.md)                                                   | Проверять определения, предпосылки и математические утверждения о повторяемости и преобразованиях.                                                           | Предложенная записка об обратимости композиции двух конечных детерминированных переходов по FUM-STEP-0206.                                                                                    | Доказательство в объявленной области, конечные иллюстрации и контрпример к усилению; предметная работа ещё не согласована.         |
...
<!-- content-sha256: sha256:ac302dae17ad8bf89de03071ac3d45a252a14ae064dea8f90177b9d9232f0372 -->
<!-- FUM-MD-RECENCY:END -->
