...
from история_модели import импортировать, подготовить_коммит, сохранить_сообщение, _путь
...
def выполнить():
    ...
    try:
        ...
        результат = импортировать(параметры.исходник, параметры.задача_источника,
        ...
        if all(поля):
            ...
            сохранить_сообщение(путь, текст)
