...
- [fum-dispetcher-avtomatizacij-fum](fum-dispetcher-avtomatizacij-fum/SKILL.md) - проверяет закрытый реестр заданий схемы `1` и автономно моделирует расписание, порог подтверждённых событий, условия допуска и состояния без выбора, claim, host-вызовов или исполнения эффектов.
...
<!-- content-sha256: sha256:77522ea699e3d6ebb55f8b47db673b79d8f206262874754c46bc060b2d258406 -->
<!-- FUM-MD-RECENCY:END -->
